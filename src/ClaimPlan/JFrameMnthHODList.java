 ...
 * @author goredemac
 */
public class JFrameMnthHODList extends javax.swing.JFrame {
    ...
    public JFrameMnthHODList(String usrLogNam) {
        initComponents();
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameMnthHODList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameMnthHODList().setVisible(true);
            }
        });
    }
